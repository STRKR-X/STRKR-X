...
- Solid backend expertise with NodeJS & ExpressJS
- Experience in full-stack development
- Passion for clean code and best practices
- Ready for relocation and remote work
...
### 🏢 GLOBAL TEXTILE
**Junior BIS Department Specialist** | Oct 2024 - Present
- Implement and configure systems for business process automation
- Analyze business requirements and propose IT solutions
- Provide user training and technical support
- Maintain system modules (finance, sales, warehouse)

### 🏢 Software Products and IT Technology Park
**Web Programmer** | Dec 2020 - Aug 2024
- Taught web programming courses
- Developed client and server parts of web applications
- Created landing pages and promotional websites
- Designed website interfaces and layouts

### 🏢 FARLINE
**Intern** | Aug 2020 - Dec 2020
- Studied IT field and network technologies
- Assisted in LAN installation and configuration
...
**⚡ Fun Fact:** I believe that clean code is not just about making it work, but about making it maintainable and scalable for the future!
